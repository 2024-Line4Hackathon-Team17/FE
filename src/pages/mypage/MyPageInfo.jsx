    ...
    const handleSave = async () => {
        try {
            ...
            const response = await axios.post(
                `${process.env.REACT_APP_API}/mypage/update_profile/`,
                {
                ...
                <main className="mypage_info_container">
                    ...
                    <div className="mypage_info_nickname_pw">
                        <div className="mypage_info_nickname">
                            ...
                            <button
                                className="btn"
                                onClick={handleConfirmNicknameCheck}
                            >
                                중복 확인
                            </button>
                        </div>
                        ...
                        <p className="password-instruction">
                            영문, 숫자 조합의 8자 이상 20자 이하로 입력해주세요.
                        </p>
                    ...
                    <div className="mypage_info_save">
                        <div
                            className="mypage_info_save_btn btn"
                            onClick={handleSave}
                        >
                            <span>저장하기</span>
                        </div>
